...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="TRAJO Fashion">
    <meta name="keywords" content="TRAJO, Fashion, Ecommerce, Clothing">
...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        <div class="offcanvas__option">
            <div class="offcanvas__links"></div>
            ...
            <div class="row">
                ...
                @php
                    ...
                    $wishlistCount = Auth::guard('customer')->check()
                        ? \App\Models\Wishlist::where('user_id', Auth::guard('customer')->id())->count()
                        : 0;
                @endphp
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="header__nav__option">
                        <a href="#" class="search-switch"><img src="{{ asset('assets/img/icon/search.png') }}" alt=""></a>
                        <a href="{{ route('wishlist.index') }}"><img src="{{ asset('assets/img/icon/heart.png') }}" alt="">[{{ $wishlistCount }}]</a>
                        <a href="{{ route('cart.view') }}"><img src="{{ asset('assets/img/icon/cart.png') }}" alt=""> <span>[{{ $cartCount }}]</span></a>
                    </div>
                </div>
            </div>
